        ...
        <>
            <div className="card text-center">
                ...
                <div className="card-body">
                    ...
                    ><i className="fab fa-facebook-f"><FaFacebookF /></i></a>
                    ...
                    <a
                        ...
                        target='_blank'
                        rel="noopener noreferrer"
                    ><i className="fab fa-instagram"><FaInstagram /></i></a>
                    ...
                    <a
                        ...
                        target='_blank'
                        rel="noopener noreferrer"
                    ><i className="fab fa-linkedin"><FaLinkedinIn /></i></a>
                    ...
                    <a
                        ...
                        role="button"
                        data-mdb-ripple-color="dark"
                    ><i className="fab fa-github"><FaGithub /></i></a>
                </div>
